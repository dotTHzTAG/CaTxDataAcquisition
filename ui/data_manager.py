...
class DataManagerWindow(QMainWindow):
    ...
    def __init__(
        ...
        self._sync_frequency_range_visibility()
    ...
    def _connect_signals(self) -> None:
        ...
        self.radioButton_spectrum.toggled.connect(
            self._sync_frequency_range_visibility
        )
        ...
        self.doubleSpinBox_freq_lb.valueChanged.connect(self._refresh_current_plot)
        self.doubleSpinBox_freq_ub.valueChanged.connect(self._refresh_current_plot)
    ...
    def _sync_frequency_range_visibility(self, _checked: bool = False) -> None:
        self.widget_freq_range.setVisible(self.radioButton_spectrum.isChecked())
    ...
    def _show_about(self) -> None:
        QMessageBox.about(
            ...
            "About Data Manager",
            about_text(
                "dotTHz Data Acquisition - Data Manager",
    ...
    def _display_trace(
        ...
        freq_min = min(
            self.doubleSpinBox_freq_lb.value(),
            self.doubleSpinBox_freq_ub.value(),
        )
        freq_max = max(
            self.doubleSpinBox_freq_lb.value(),
            self.doubleSpinBox_freq_ub.value(),
        )
        frequency_mask = (frequency_thz >= freq_min) & (frequency_thz <= freq_max)
        frequency_thz = frequency_thz[frequency_mask]
