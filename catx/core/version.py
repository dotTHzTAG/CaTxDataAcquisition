...
def about_text(product_name: str, description: str) -> str:
    return (
        f"{product_name}\n\n"
        f"{description}\n\n"
        "Part of the dotTHz project.\n"
        "Originally developed for Menlo Systems ScanControl.\n"
        "Supplied acquisition backend: Menlo ScanControl.\n"
        "Other commercial and home-built THz systems require customisation.\n\n"
        "User manual: docs/USER_MANUAL.md\n"
        "Adaptation and AI coding guidance: docs/CUSTOMISATION.md\n\n"
